...
| <a name="input_databases"></a> [databases](#input_databases)                               | The logical database to create and configure                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | <pre>list(object({<br/> name = string<br/> connection_limit = optional(number)<br/> }))</pre> | n/a                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |   yes    |
